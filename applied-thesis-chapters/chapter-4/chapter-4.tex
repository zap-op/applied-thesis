...
\tab Như đã trình bày ở mục \textit{\ref{subsubsec:ThietKeKienTrucTangUngDung} \nameref{subsubsec:ThietKeKienTrucTangUngDung}}, hệ thống bao gồm nhiều service được cài đặt tách biệt với nhau và có các tác dụng khác nhau.
...
\tab Như đã mô tả ở phần "Nhóm ZAP service" của mục \textit{\ref{subsubsec:ThietKeKienTrucTangUngDung} \nameref{subsubsec:ThietKeKienTrucTangUngDung}}, cài đặt nhóm ZAP service cũng là một trong những phần khó nhất trong việc xây dựng ứng dụng hệ thống.
...
\tab Như đã trình bày ở phần "Nhóm ZAP service" của mục \textit{\ref{subsubsec:ThietKeKienTrucTangUngDung} \nameref{subsubsec:ThietKeKienTrucTangUngDung}}, service đóng vai trò trung gian giữa ứng dụng hệ thống và ZAP Client service.
...
Hai cookie trên là 2 JSON Web Token (JWT) token được tạo qua phương thức signJwt() trong service, phương thức được cài đặt bằng cách sử dụng gói jsonwebtoken và khóa riêng tư (private key) của ứng dụng hệ thống là ZAP\_OP\_PRIVATE\_KEY.
...
Ở ứng dụng web, cách thể hiện giao diện màn hình kết quả quét chi tiết của các loại quét cũng khác nhau.
